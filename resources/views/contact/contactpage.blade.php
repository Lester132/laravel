  ...
  <section class="ftco-section contact-section ftco-degree-bg">
    <div class="container">
      <div class="row d-flex mb-5 contact-info">
        ...
        <div class="w-100"></div>
        <div class="col-md-3">
          <p><span><i class="fa-solid fa-map-pin"></i> Address:</span> 
            <a href="https://maps.app.goo.gl/2zNJs6eqdvCgNqVT7">
              {{ $contactInfo->address }}
            </a>
          </p>
        </div>
        <div class="col-md-3">
          <p><span><i class="fa-solid fa-phone"></i> Phone:</span> 
        ...
        <div class="col-md-3">
          <p><span><i class="fas fa-envelope"></i> Email: </span> 
        ...
        <div class="col-md-3">
          <p><span><i class="fab fa-facebook-square"></i> Facebook: </span> 
            <a href="{{ $contactInfo->facebook }}">Visit our Facebook Page</a>
          </p>
        </div>
      </div>
    </div>
